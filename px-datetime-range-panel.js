...
import 'px-datetime-common/px-datetime-presets.js';
...
import './css/px-datetime-range-panel-styles.js';
...
`,
  ...
  _handleButtonClick: function(evt){
    if(this.hidePresets === false && evt.detail.action === false){
      var presets = dom(this.root).querySelector('px-datetime-presets');
